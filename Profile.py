...
class Profile:
    ...
    """
    add_bio adds in something to the bio element of the Profile object
    """
    ...
    """
    add_location adds in something to the location element of the Profile object
    """

    def add_location(self, ccode: str, zipcode: str):
        self.location.append(ccode)
        self.location.append(zipcode)


    """
    add_song adds in something to the location element of the Profile object
    """

    def add_song(self, track_name: str, track_artist: str):
        self.song = f'{track_name} by {track_artist}'
